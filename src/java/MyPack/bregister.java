...
public class bregister extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        stmt.executeUpdate("insert into bregister(bname,registration number,address,pincode,location,password,email,contact number)values('"+name+"','"+reg_num+"','"+add+"','"+pin+"','"+loc+"',"+pass+"','"+email+"','"+num+"') ");
