...
public class hregister extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        stmt.executeUpdate("insert into hregister(hname,registratrion number,address,pincode,location,contact number,password,email)values('"+name+"','"+reg_num+"','"+add+"','"+pin+"','"+loc+"','"+num+"','"+pass+"','"+email+"') ");
